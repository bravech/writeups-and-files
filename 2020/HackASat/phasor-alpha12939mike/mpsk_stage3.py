...
class mpsk_stage3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, timing_loop_bw, rrc_taps, nfilts, nfilts/2, 1.5, 1)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/charlie/Downloads/phasor2-yankee92047bravo/challenge.wav', True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/charlie/Downloads/phasor2-yankee92047bravo/demod.wav', 2, samp_rate, 8)
